              ...
              <div className="i-con">
                ...
                <div className="login">
                  <i
                    className={
                      !darkMode
                        ? "fs-5 fa-regular fa-moon"
                        : "fs-5 fa-solid fa-sun rotate"
                    }
                    onClick={changeMood}
                  ></i>
                </div>
            ...
            <div className="item">
              ...
              <nav>
                <ul>
                  <li>
                    <LinkContainer to={"/"}>
                      <NavLink className={"text-none"}>{t("header.0")}</NavLink>
                    </LinkContainer>
                  </li>
                  <li>
                    <LinkContainer to={"/shop"}>
                      <NavLink className={"text-none"}>{t("header.1")}</NavLink>
                    </LinkContainer>
                  </li>
                  <li>
                    <LinkContainer to={"/pages"}>
                      <NavLink className={"text-none"}>{t("header.2")}</NavLink>
                    </LinkContainer>
                  </li>
                  <li>
                    <LinkContainer to={"/blog"}>
                      <NavLink className={"text-none"}>{t("header.3")}</NavLink>
                    </LinkContainer>
                  </li>
                  <li>
                    <LinkContainer to={"/contact"}>
                      <NavLink className={"text-none"}>{t("header.4")}</NavLink>
                    </LinkContainer>
                  </li>
                  <li>
        ...
        <div className={context.isOpen ? "nav-menu opn" : "nav-menu"}>
          ...
          <nav>
            <ul>
              <li>
                <LinkContainer to={"/"}>
                  <NavLink className={"text-none"}>Home</NavLink>
                </LinkContainer>
              </li>
              <li>
                <LinkContainer to={"/shop"}>
                  <NavLink className={"text-none"}>Shop</NavLink>
                </LinkContainer>
              </li>
              <li>
                <LinkContainer to={"/pages"}>
                  <NavLink className={"text-none"}>Pages</NavLink>
                </LinkContainer>
              </li>
              <li>
                <LinkContainer to={"/blog"}>
                  <NavLink className={"text-none"}>Blog</NavLink>
                </LinkContainer>
              </li>
              <li>
                <LinkContainer to={"/contact"}>
                  <NavLink className={"text-none"}>Contact</NavLink>
                </LinkContainer>
              </li>
            </ul>
          </nav>
